 ...
 * @LastEditTime: 2022-07-05 18:45:34
 * @Description: 
-->
<template>
    <div class="charts-pages-layout-new" v-loading="chartsLoading">
...
import { useNewCharts } from "@/composables/useNewCharts";
import { RenderBarChart } from "@/plugins/charts";
export default {
    name: "charts-pages-layout-new",
    //混入
    mixins: [],
