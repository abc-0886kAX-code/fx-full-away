<template>
    <div class="ytxd-user-controller">
        ...
        <el-dropdown class="user-handler" size="small" split-button type="primary" @command="handleCommand"
            @click="handleUser">
            {{ userName }}
...
<script>
import DefUserIcon from "@/assets/images/other/def-user-icon.png";
import { isFunction } from "lodash";
import { delToken, cacheGet, shortCacheDel, cacheDel } from "maggot-utils";
...
export default {
    ...
    data() {
        ...
        return {
            ...
            userName: cacheGet("username") || "管理员",
