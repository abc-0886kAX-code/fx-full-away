 ...
 * @LastEditTime: 2022-07-20 19:07:34
 * @Description: file content
-->
<template>
    <div class="dialog-rainfall-site-ydh">
...
import { getChartsData } from "@/pages/basin-flood/components/basin-ydh/api";
...
@import "./dialog-rainfall-site-ydh.scss";
</style>
