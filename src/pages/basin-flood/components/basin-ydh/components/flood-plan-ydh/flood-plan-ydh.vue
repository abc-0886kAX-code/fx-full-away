 ...
 * @LastEditTime: 2022-06-30 17:38:23
 * @Description: 
-->
<template>
    <div class="flood-plan-ydh reservoirBtn">
...
const setupRoundPoint = (source) => {
    ...
    return new BillboardEntity({
        ...
        attr: {
            ...source,
            dialogName: "dialog-flood-plan-ydh",
            setupFloat,
        },
        ...shape,
    });
...
export default {
    ...
    setup() {
        ...
        const executeQuery = async () => {
            const data = await getReservoirSiteByUser({ hnnm: "ACB00006" });
