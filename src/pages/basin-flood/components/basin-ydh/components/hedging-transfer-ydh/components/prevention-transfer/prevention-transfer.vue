 ...
 * @LastEditTime: 2022-06-22 17:37:36
 * @Description: 
-->
<script>
    ...
    ({ legend }) =>
        (source) => {
            ...
            return new BillboardEntity({
                ...
                attr: {
                    ...source,
                    dialogName: "dialog-prevention-transfer-cbh",
                    setupFloat,
                },
                ...shape,
            });
...
export default {
    ...
    setup(props) {
        ...
        const layer = setupLayer({
            type: "graphic",
            name: "PTCBHPointLayer",
            zIndex: 1005,
        });
        const layerEnity = unref(gather).PTCBHPointLayer;
        ...
        const handlerClickFilter = ["dialog-prevention-transfer-cbh"];
