 ...
 * @LastEditTime: 2022-07-20 19:07:09
 * @Description: file content
-->
<template>
    <div class="dialog-rainfall-site-jyh">
...
import { getChartsData } from "@/pages/basin-flood/components/basin-jyh/api";
...
@import "./dialog-rainfall-site-jyh.scss";
</style>
