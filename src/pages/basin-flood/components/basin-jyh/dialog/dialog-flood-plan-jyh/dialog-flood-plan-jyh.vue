 ...
 * @LastEditTime: 2022-07-05 17:44:32
 * @Description: 
-->
<template>
    <div class="dialog-flood-plan-jyh">
...
import { dialogInstall } from "@/pages/basin-flood/dialog/dialog-install";
...
const tabs = [
    ...
    {
        id: "water-custom-routing",
        label: "水量自定义演算",
    },
];

export default {
    name: "dialog-flood-plan-jyh",
    mixins: [DialogContentMixins],
    components: { ...bizComponents, ...dialogInstall },
    props: {},
    setup(props, context) {
