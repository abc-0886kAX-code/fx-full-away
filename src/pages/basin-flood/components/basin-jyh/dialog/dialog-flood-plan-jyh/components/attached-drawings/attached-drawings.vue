 ...
 * @LastEditTime: 2022-06-24 14:42:10
 * @Description: 
-->
<template>
    <div class="ytxd-attached-drawings">
...
export default {
    name: "ytxd-attached-drawings",
    mixins: [DialogContentMixins],
    components: {},
    props: {},
    setup(props, context) {
        const params = computed(() => {
            return { stcd: props.info.stcd, lxid: "chart" };
        });
