 ...
 * @LastEditTime: 2022-06-22 17:36:54
 * @Description: 
-->
<script>
...
import { getWaterConservancyRanksList } from "../../api/pervention-material.api";
    ...
    ({ legend }) =>
        (source) => {
            ...
            return new BillboardEntity({
                ...
                attr: {
                    ...source,
                    dialogName: "dialog-water-conservancy-ranks-jyh",
                    setupFloat,
                },
                ...shape,
            });
...
export default {
    ...
    setup(props) {
        ...
        const layer = setupLayer({
            type: "graphic",
            name: "WCRJYHPointLayer",
            zIndex: 1005,
        });
        const layerEnity = unref(gather).WCRJYHPointLayer;
        ...
        async function executeQuery() {
            const data = await getWaterConservancyRanksList();
