 ...
 * @LastEditTime: 2022-06-22 16:22:25
 * @Description: 
-->
<template>
    <div class="flood-plan-jyh reservoirBtn">
...
const setupRoundPoint = (source) => {
    ...
    return new BillboardEntity({
        ...
        attr: {
            ...source,
            dialogName: "dialog-flood-plan-jyh",
            setupFloat,
        },
        ...shape,
    });
...
export default {
    ...
    setup() {
        ...
        const executeQuery = async () => {
            const data = await getReservoirSiteByUser({ hnnm: "ACB10003" });
