 ...
 * @LastEditTime: 2022-06-30 17:18:36
 * @Description: 
-->
<template>
    <div class="flood-plan-byh reservoirBtn">
...
const setupRoundPoint = (source) => {
    ...
    return new BillboardEntity({
        ...
        attr: {
            ...source,
            dialogName: "dialog-flood-plan-byh",
            setupFloat,
        },
        ...shape,
    });
...
export default {
    ...
    setup() {
        ...
        const executeQuery = async () => {
            const data = await getReservoirSiteByUser({ hnnm: "ACB13003" });
