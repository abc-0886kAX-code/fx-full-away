 ...
 * @LastEditTime: 2022-07-20 19:06:37
 * @Description: file content
-->
<template>
    <div class="dialog-rainfall-site-byh">
...
import { getChartsData } from "@/pages/basin-flood/components/basin-byh/api";
...
@import "./dialog-rainfall-site-byh.scss";
</style>
