<!--
 * @FilePath: \3D防汛作战\src\pages\basin-flood\components\basin-cbh\components\basic-data-cbh\components\river.vue
 * @Author: zhangyang
 * @Date: 2022-06-17 10:18:45
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-06-22 11:43:49
 * @Description: 河道
-->
<script>
...
export default {
    ...
    setup() {
        ...
        const layerEnity = unref(gather).CBHRiverLayer;
