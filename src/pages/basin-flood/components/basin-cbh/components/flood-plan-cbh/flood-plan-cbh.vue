 ...
 * @LastEditTime: 2022-06-22 16:20:55
 * @Description: 
-->
<template>
    <div class="flood-plan-cbh reservoirBtn">
...
const setupRoundPoint = (source) => {
    ...
    return new BillboardEntity({
        ...
        attr: {
            ...source,
            dialogName: "dialog-flood-plan-cbh",
            setupFloat,
        },
        ...shape,
    });
...
export default {
    ...
    setup() {
        ...
        const executeQuery = async () => {
            const data = await getReservoirSiteByUser({ hnnm: "ACB11006" });
