 ...
 * @LastEditTime: 2022-07-04 16:40:49
 * @Description: 
 */
import { default as FloodSimulation } from './flood-simulation';
import { default as IcmModelPrediction } from './icm-model-prediction';
import { default as IcmModelPredictionItem } from './icm-model-prediction-item';
import { default as RainfallSite } from './rainfall-site';
const components = [
    RainfallSite,
    FloodSimulation,
    IcmModelPrediction,
    IcmModelPredictionItem
];
