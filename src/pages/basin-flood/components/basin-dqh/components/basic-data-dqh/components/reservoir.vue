<!--
 * @FilePath: \3D防汛作战\src\pages\basin-flood\components\basin-cbh\components\basic-data-cbh\components\reservoir.vue
 * @Author: zhangyang
 * @Date: 2022-06-17 10:18:51
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-06-22 11:44:47
 * @Description: 水库
-->
<script>
import { EventType } from "mars3d";

import { inject, unref, onMounted, onBeforeUnmount } from "@vue/composition-api";
...
export default {
    ...
    setup() {
        ...
        const layer = setupLayer({
            type: "graphic",
            name: "CBHReservoirLayer",
            zIndex: 1005
        });
        const layerEnity = unref(gather).CBHReservoirLayer;
