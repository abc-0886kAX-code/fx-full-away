 ...
 * @LastEditTime: 2022-07-20 19:06:53
 * @Description: file content
-->
<template>
    <div class="dialog-rainfall-site-dqh">
...
import { getChartsData } from "@/pages/basin-flood/components/basin-dqh/api";
...
@import "./dialog-rainfall-site-dqh.scss";
</style>
