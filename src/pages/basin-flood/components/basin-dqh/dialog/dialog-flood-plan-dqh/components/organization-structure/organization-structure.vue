 ...
 * @LastEditTime: 2022-06-24 14:42:04
 * @Description: 
-->
<template>
    <div class="ytxd-organization-structure">
...
export default {
    name: "ytxd-organization-structure",
    mixins: [DialogContentMixins],
    components: {},
    props: {},
    setup(props, context) {
        const params = computed(() => {
            return { stcd: props.info.stcd, lxid: "organization" };
        });
