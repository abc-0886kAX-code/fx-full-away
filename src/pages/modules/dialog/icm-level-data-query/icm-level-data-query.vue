<!--
 * @FilePath: \3D防汛作战\src\pages\modules\dialog\icm-level-data-query\icm-level-data-query.vue
 * @Author: zhangyang
 * @Date: 2022-06-30 16:01:00
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-01 10:56:59
 * @Description: 
-->
<template>
    <mg-table class='modules-body icm-level-data-query' v-loading="tableLoading" v-bind="loadStyle"
...
import { icmQueryWaterLevelData } from "@/api/icm/query.api";

import { default as DialogContentMixins } from "@/mixins/dialog-content.mixins";

export default {
    name: 'icm-level-data-query',
    ...
    setup(props) {
        ...
        const {
            ...
            setupTableColumn,
            setupUiSchema
        } = useTableData("icm-level-data-query");
        ...
        const executeQuery = async () => {
            dialogLoadStart();
            const { datacase, columns } = await icmQueryWaterLevelData(props.info);
...
@import "./icm-level-data-query.scss";
