 ...
 * @LastEditTime: 2022-06-06 15:35:51
 * @Description: 
-->
<template>
    <div class="dialog-real-time-reservoir-hydrological">
...
export default {
    name: "dialog-real-time-reservoir-hydrological",
    //混入
...
.dialog-real-time-reservoir-hydrological {
    width: 100%;
    height: 100%;
    overflow: hidden;
}
