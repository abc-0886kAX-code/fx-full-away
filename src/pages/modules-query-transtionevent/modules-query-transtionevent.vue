<!--
 * @FilePath: \3D防汛作战\src\pages\modules-query-transtionevent\modules-query-transtionevent.vue
 * @Author: zhangyang
 * @Date: 2022-06-29 10:19:36
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-08 13:21:10
 * @Description: 
-->
<template>
    <mg-table class="modules-body modules-query-transtionevent" v-loading="tableLoading" v-bind="loadStyle"
...
export default {
    name: "modules-query-transtionevent",
    mixins: [],
    components: {},
    props: {},
    setup() {
        const {
            ...
            setupUiSchema,
            setupRowController,
        } = useTableData("modules-query-transtionevent");
        ...
        const executeQuery = async (params = {}) => {
            setupLoading();
            const data = await setupTableData(icmQueryTranstionEvent(params));
            return { data };
        };
...
@import "./modules-query-transtionevent.scss";
