<!--
 * @FilePath: \3D防汛作战\src\pages\modules-query-waterevent\modules-query-waterevent.vue
 * @Author: zhangyang
 * @Date: 2022-06-29 10:19:36
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-08 13:21:17
 * @Description: 
-->
<template>
    <mg-table class='modules-body modules-query-waterevent' v-loading="tableLoading" v-bind="loadStyle"
...
export default {
    ...
    setup() {
        const {
            ...
            setupUiSchema,
            setupRowController
        } = useTableData("modules-query-waterevent");
        ...
        const executeQuery = async (params = {}) => {
            setupLoading();
            const data = await setupTableData(icmQueryWaterLevelEvent(params));
            return { data };
        }
...
@import "./modules-query-waterevent.scss";
