<!--
 * @FilePath: \3D防汛作战\src\pages\modules-import-waterlevel\modules-import-waterlevel.vue
 * @Author: zhangyang
 * @Date: 2022-06-29 10:19:18
 * @LastEditors: zhangxin
 * @LastEditTime: 2022-07-13 10:32:10
 * @Description: 
-->
<template>
    <data-import-form
        class="modules-body modules-import-waterlevel"
        v-loading="loading"
        v-bind="loadStyle"
...
export default {
    name: "modules-import-waterlevel",
    mixins: [],
    ...
    setup() {
        ...
        const { loading, loadStyle, setupLoading: setupHomeLoading } = Load();
...
@import "./modules-import-waterlevel.scss";
</style>
