<!--
 * @Author: maggot-code
 * @Date: 2022-05-23 14:13:40
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-14 17:04:12
 * @Description: file content
-->
<template>
    <rainfall-legend v-loading="loading" v-bind="loadStyle" class='rainfall-peak' :info="legendProps"
...
import { getRainfallPeakData } from "@/pages/rainfall-forecast/api/prediction.api";
...
export default {
    ...
    setup() {
        ...
        const executeQuery = async () => {
            ...
            const result = await getRainfallPeakData();
