<!--
 * @FilePath: \3D防汛作战\src\pages\modules-import-rainevent\modules-import-rainevent.vue
 * @Author: zhangyang
 * @Date: 2022-06-29 10:19:18
 * @LastEditors: zhangxin
 * @LastEditTime: 2022-07-13 10:31:58
 * @Description: 
-->
<template>
    <data-import-form
        class="modules-body modules-import-rainevent"
        v-loading="loading"
        v-bind="loadStyle"
    ...
    setup() {
        ...
        const submitForm = (formEl, source) => {
            ...
            formEl.validate(async (valid) => {
                ...
                const options = await importRainfallData(unref(params));
...
@import "./modules-import-rainevent.scss";
</style>
