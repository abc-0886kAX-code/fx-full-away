<!--
 * @FilePath: \3D防汛作战\src\pages\modules-query-inflow\modules-query-inflow.vue
 * @Author: zhangyang
 * @Date: 2022-06-29 10:19:36
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-08 13:19:34
 * @Description: 
-->
<template>
    <mg-table class="modules-body modules-query-inflow" v-loading="tableLoading" v-bind="loadStyle"
...
export default {
    ...
    setup() {
        const {
            ...
            setupUiSchema,
            setupRowController,
        } = useTableData("modules-query-inflow");
        ...
        const executeQuery = async (params = {}) => {
            setupLoading();
            const data = await setupTableData(icmQueryInflowEvent(params));
            return { data };
        };
...
@import "./modules-query-inflow.scss";
