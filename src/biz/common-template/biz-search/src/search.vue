<!--
 * @Author: zhangyang
 * @Date: 2021-06-10 11:13:43
 * @LastEditors: zhangyang
 * @LastEditTime: 2022-07-06 16:48:15
 * @Description: file content
-->
<template>
    <mg-form class="biz-controller-search" ref="search" :proName="proName" :schema="searchFormSchema">
    ...
    methods: {
        ...
        getFormData() {
            const { validate = false, data = {} } =
                this.$refs.search && this.$refs.search.formOutput();
            return {
                checkFunc: validate,
                data: data,
            };
